...
- **Untested functionality:** Recovery of deleted file fragments (`--deleted`) and encrypted volumes (`--password`) have been implemented but not yet fully tested. Linux compilation and execution have also not yet been thoroughly tested.
